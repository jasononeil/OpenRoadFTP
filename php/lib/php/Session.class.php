...
class php_Session {
	...
	static function setCookieParams($lifetime, $path, $domain, $secure, $httponly) {
		...
		session_get_cookie_params($lifetime, $path, $domain, $secure, $httponly);
	}
	...
	static function close() {
		session_write_close();
		php_Session::$_started = false;
	}
	function __toString() { return 'php.Session'; }
}
php_Session::$_started = isset($_SESSION);
