...
class XmlTest {
	...
	static function main() {
		...
		XmlTest::pushResults("AdvXmlItem Test page");
		XmlTest::pushResults("This is a test page to test as many of the functions of my AdvXmlItem class as I can");
		...
		$xmlDoc = new jasononeil_xml_AdvXmlItem($xmlStr, null, null);
		...
		XmlTest::pushResults(null);
		XmlTest::pushResults("By default when you construct from a string, the AdvXmlItem object will have the type \"document\".");
		...
		$ul->hempty();
		$ul->appendChild(new jasononeil_xml_AdvXmlItem("<li>YEAH</li>", null, null));
		$ul->prependChild(new jasononeil_xml_AdvXmlItem("\x0A\x09\x09\x09<li>Combined Add</li>\x0A\x09\x09\x09<li>Combined Add 2</li>\x0A\x09\x09\x09", null, null));
		$loserMenuItem = null;
		$loserMenuItem = new jasononeil_xml_AdvXmlItem("<test />", null, null);
		...
		$constructByString = null; $constructByXml = null; $constructByAdvXmlItem = null;
		$constructByString = new jasononeil_xml_AdvXmlItem("<b>Hey you</b>", null, null);
		$constructByXml = new jasononeil_xml_AdvXmlItem(null, $constructByString->getter_xml(), null);
		$constructByAdvXmlItem = new jasononeil_xml_AdvXmlItem(null, null, $constructByString);
		XmlTest::pushResults("By String: \x09" . $constructByString);
		XmlTest::pushResults("By Xml:    \x09" . $constructByXml);
		XmlTest::pushResults("By AdvXmlItem: \x09" . $constructByAdvXmlItem);
		XmlTest::pushResults(null);
