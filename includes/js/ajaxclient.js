...
var Async_Api = $hxClasses["Async_Api"] = function(c) {
	this.__cnx = c;
}
...
var ApiProxy = $hxClasses["ApiProxy"] = function(c) {
...
var AjaxClient = $hxClasses["AjaxClient"] = function() { }
...
hxbase.util.Error = $hxClasses["hxbase.util.Error"] = function(str,pos) {
	this.code = "ERROR";
	this.error = str;
